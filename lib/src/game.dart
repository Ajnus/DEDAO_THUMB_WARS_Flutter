...
class _GamePageState extends State<GamePage> with TickerProviderStateMixin{
  ...
  static const audioPath3 = "John Williams - Battle of the Heroes (Official Audio).mp3";
  ...
  void initState() {
    ...
    Future.delayed(Duration(seconds: 29), () {showOverlay(context);});
    Future.delayed(Duration(seconds: 39+5), () {showOverlay2(context);});
    Future.delayed(Duration(seconds: 50), () {showOverlay3(context);});
    Future.delayed(
  ...
  showOverlay3(BuildContext context) async{
    OverlayState overlayState = Overlay.of(context);
    OverlayEntry overlayEntry = 
      OverlayEntry(/*opaque: true,*/ builder: (context) => Positioned(
        bottom: 123.0,
        right: 0.0,
  ...
  showOverlay4(BuildContext context) async{
    ...
    OverlayEntry overlayEntry = 
      OverlayEntry(/*opaque: true,*/ builder: (context) => Positioned(
        top: 90.0,
        right: 0.0,
        child: Opacity(opacity: 0.65, child: (Image.asset('assets/images/vadertable.png')))
        ));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('DEDão WARS'), automaticallyImplyLeading: false,
        textTheme: TextTheme(
          title: TextStyle(
            fontFamily: 'StarJedi',
